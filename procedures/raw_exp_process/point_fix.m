function x = point_fix(FNid, FNcoords, distdata)
...
[x,resnorm] = LSQNONLIN(@nonlin_err,[-142 0 0],[],[],optimset('Display','off','Jacobian','on','TolX',1e-10,'MaxFunEvals',10^(10^(1e10000))),myFNcoords,beac_dists);
